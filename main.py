...
async def startup_event():
    ...
    try:
        ...
        print(f"💥 FATAL: 앱 초기화 중 심각한 오류 발생! 원인: {INITIALIZATION_ERROR_MESSAGE}")
    ...
    try:
        while True:
            try:
                ...
                # ✨✨✨ 1. STT 호출을 안전한 비동기 방식으로 변경 ✨✨✨
                config = speech.RecognitionConfig(encoding=speech.RecognitionConfig.AudioEncoding.WEBM_OPUS, sample_rate_hertz=48000, language_code="ko-KR")
