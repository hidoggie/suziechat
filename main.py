...
async def websocket_endpoint(websocket: WebSocket):
    ...
    try:
        while True:
            ...
            if message_type == "audio":
                ...
                if user_text: # STT 결과가 있을 때만 프론트로 전송
  ...
  #             
        ...
        await websocket.send_json({"type": "error", "data": "요청 처리 중 오류가 발생했습니다."})

    except Exception as e: print(f"💥 웹소켓의 최상위 오류 ({client_id}): {e}")
